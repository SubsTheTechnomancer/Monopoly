...
public class ChanceAndCommunity : MonoBehaviour
{
    ...
    string[] Community = new string[17]
        {
            "Advance to Go. (Collect $200).",
    ...
    {
        string data = Chance[Random.Range(0,16)];
        Cardtext.text = data;
    }

    public void CommunityCard()
    {
        string data = Community[Random.Range(0,17)];
        Cardtext.text = data;
    }
